  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <fieldset className='w-full flex flex-col gap-2 items-center justify-center border border-white py-10'>
        ...
        <button  className='w-full pr-20 flex items-center rounded-[2px] bg-[#03c75a] min-w-[280px] max-w-[400px] hover:bg-opacity-70'>
          <img src="/naverLogo.png" alt="logo" className='w-[54px] h-[54px]' />
            <p className='text-lg w-full text-end'>네이버 로그인</p>
          </button>
        </li>
        <li className='w-full flex items-center justify-center'>
        <button  className='w-full pr-20 flex items-center rounded-[2px] bg-[#4285f4]  box-border min-w-[280px] max-w-[400px] hover:bg-opacity-70'>
          <img src="/googleLogo.jpeg" alt="logo" className='w-[48px] h-[48px] p-1' />
            <p className='text-lg text-white w-full text-end'>구글 로그인</p>
          </button>
        </li>
        <li className='w-full flex items-center justify-center'>
        <button  className='w-full pr-20 flex items-center rounded-[2px] bg-[#FEE500] min-w-[280px]  max-w-[400px] hover:bg-opacity-70'>
