  ...
  return (
    <div className='w-full min-h-[800px] bg-red-200 flex flex-col justify-center items-center'>
      ...
      <p className='mb-10'>
        ...
        <span className='block text-center text-lg'>책임의 소재를 밝혀줄 유일한 목격자는 지금 바로 이 페이지를 보고 있는 당신입니다!</span>
        <span className='block text-center text-lg'>해당 페이지를 캡쳐하여 보내주신다면 무엇이 잘못되었는지, 어떤 조치를 취하였는지 보고드리겠습니다.</span>
      </p>
      <button
